...
#Path 1
print("Code of your pets: ",end = "")
print(data_dict[string_in[0]],end = ",")
print(data_dict[string_in[1]],end = ",")
print(data_dict[string_in[2]],end = ",")
print(data_dict[string_in[3]],end = ",")
print(data_dict[string_in[4]],end = "\n")
