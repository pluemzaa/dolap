...
<flowgorithm fileversion="4.2">
    <attributes>
        <attribute name="name" value="4.2"/>
        <attribute name="authors" value="asus"/>
        <attribute name="about" value=""/>
        <attribute name="saved" value="2025-07-16 09:33:27 PM"/>
        <attribute name="created" value="YXN1cztMQVBUT1AtNzM3TDlPSFA7MjAyNS0wNy0xNjswMjoyODo1NyBQTTsyNzY5"/>
        <attribute name="edited" value="YXN1cztMQVBUT1AtNzM3TDlPSFA7MjAyNS0wNy0xNjswOTozMzoyNyBQTTs3OzI4ODM="/>
    </attributes>
    <function name="Main" type="None" variable="">
        <parameters/>
        <body>
            <declare name="c, t, cp, tp, i, n" type="Real" array="False" size=""/>
