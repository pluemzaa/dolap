...
numf0 =  (numt[0] is max(numt[0]) in num)
numf1 =  (numt[1] is max(numt[1]) in num )
numf2 =  (numt[2] is max(numt[2]) in num )
numf3 =  (numt[3] is max(numt[3]) in num )
numf4 =  (numt[4] is max(numt[4]) in num )
