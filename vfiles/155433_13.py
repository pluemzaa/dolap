...
numf0 =  (numt[0] is max(numt0) in numt)
numf1 =  (numt[1] is max(numt1) in numt)
numf2 =  (numt[2] is max(numt2) in numt)
numf3 =  (numt[3] is max(numt3) in numt)
numf4 =  (numt[4] is max(numt4) in numt) 
