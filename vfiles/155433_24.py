...
n0 =  (numt[0] is max(numt[0]) in numt)
n1 =  (numt[1] is max(numt[1]) in numt)
n2 =  (numt[2] is max(numt[2]) in numt)
n3 =  (numt[3] is max(numt[3]) in numt)
n4 =  (numt[4] is max(numt[4]) in numt) 
