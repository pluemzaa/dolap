...
numf0 =  (numt[0] is min(numt[0]) in numt )
numf1 =  (numt[1] is min(numt[1]) in numt )
numf2 =  (numt[2] is min(numt[2]) in numt )
numf3 =  (numt[3] is min(numt[3]) in numt )
numf4 =  (numt[4] is min(numt[4]) in numt ) 
