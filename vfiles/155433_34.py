...
numf0 =  (numt[0] is max(num) in maximum)
numf1 =  (numt[1] is max(num) in maximum)
numf2 =  (numt[2] is max(num) in maximum)
numf3 =  (numt[3] is max(num) in maximum)
numf4 =  (numt[4] is max(num) in maximum)
