...
numf0 =  (numt[0] is max(numf0) in numt)
numf1 =  (numt[1] is max(numf1) in numt)
numf2 =  (numt[2] is max(numf2) in numt)
numf3 =  (numt[3] is max(numf3) in numt)
numf4 =  (numt[4] is max(numf4) in numt)
