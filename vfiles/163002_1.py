...
print(f"{item1:<15}{weight1:>7.2f}")
print(f"{item2:<15}{weight2:>7.2f}")
print(f"{item3:<15}{weight3:>7.2f}")
print(f"{item4:<15}{weight4:>7.2f}")
print("---------------------------")
print(f"{'total':<15}{total_weight:>7.2f}")